...
function Footer() {
  return (
    <div style={{width:'100%',height:'350px'}} className='d-flex flex-column justify-content-center align-items-center text-light bg-primary mt-5'>
    <div className="footer-div d-flex justify-content-evenly flex-wrap w-100">
      <div className="website" style={{width:'400px'}}>
        <h4><i className="fa-brands fa-stack-overflow fa-bounce"></i> Project Fair</h4>
      ...
      <div className="content">
        ...
        <div className="sub d-flex" >
          <input type="text" className='form-control bg-light rounded ps-2' placeholder='Enter your Email Id'/>
          <button className='btn btn-light ms-4 ps-3 pe-3 pt-2'><i className="fa-sharp fa-solid fa-right-long text-primary"></i></button>
        </div>
        ...
        <Link to={'/watch-historys'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-linkedin"></i></Link>
        <Link to={'/watch-historys'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-instagram"></i></Link>
        <Link to={'/watch-historys'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-github"></i></Link>
        <Link to={'/watch-historys'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-facebook"></i></Link>
        </div>
      </div>
